...
public class frmEquipamiento extends javax.swing.JFrame {
    ...
    private JComboBox<String>[] jcbxs;
    private JButton[] jbtnAgregars;

    private Articulo[] articulos = {
        new Articulo("Botines", 2.0),
        new Articulo("Guantes", 1.5),
        new Articulo("Canilleras", 1.0),
        new Articulo("Polos", 2.0),
        new Articulo("Tarjetas", 0.5),
        new Articulo("Medias", 1.0)
    };
    ...
    public frmEquipamiento(Campo_1 campo1, Campo_2 campo2, Campo_3 campo3, Campo_4 campo4, Campo_5 campo5, Campo_6 campo6) {
        ...
        jbtnAgregars = new JButton[]{jbtnAgregarZapatillas, jbtnAgregar2, jbtnAgregar3, jbtnAgregar4, jbtnAgregar5, jbtnAgregar6};
        ...
        for (int i = 0; i < articulos.length; i++) {
            ...
            jbtnAgregars[i].addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    agregarAlCarrito(articulos[indiceArticulo], jcbxs[indiceArticulo]);
                }
            });
        }
    }

    private void agregarAlCarrito(Articulo articulo, JComboBox<String> comboboxCantidad) {
        ...
        carrito.add(item);
        modeloTabla.addRow(new Object[]{item.getArticulo().getNombre(), item.getCantidad(), item.getArticulo().getPrecioUnitario(), item.getPrecioTotal()});
    ...
    private void calcularTotal() {
        ...
        jtxtTotalPagar.setText(" " + String.format("%.2f", total));
    }
    ...
    private void initComponents() {
        ...
        jbtnAgregarZapatillas = new javax.swing.JButton();
        ...
        pEquipamiento1.add(jLabel32, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 70, 80, 80));

        jLabel33.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Vista/soccer-boots.png"))); // NOI18N
        pEquipamiento1.add(jLabel33, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 50, 80, 80));

        jLabel34.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Vista/gloves (1).png"))); // NOI18N
        pEquipamiento1.add(jLabel34, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 60, 70, 80));
        ...
        pEquipamiento1.add(jLabel36, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 270, 60, 80));

        jLabel37.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Vista/red-card.png"))); // NOI18N
        pEquipamiento1.add(jLabel37, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 270, 80, 80));

        jLabel38.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Vista/football-long-socks-with-white-lines (1).png"))); // NOI18N
        pEquipamiento1.add(jLabel38, new org.netbeans.lib.awtextra.AbsoluteConstraints(376, 270, -1, 70));

        jLabel39.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Vista/football-long-socks-with-white-lines (1).png"))); // NOI18N
        pEquipamiento1.add(jLabel39, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 270, 80, 70));

        jLabel1.setText("S/.10.00");
        pEquipamiento1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 350, -1, -1));

        jLabel2.setText("S/.10.00");
        pEquipamiento1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 140, -1, -1));

        jLabel3.setText("S/.10.00");
        pEquipamiento1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 140, -1, -1));

        jLabel4.setText("S/.10.00");
        pEquipamiento1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 140, -1, -1));

        jLabel5.setText("S/.10.00");
        pEquipamiento1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 350, -1, -1));

        jLabel6.setText("S/.10.00");
        pEquipamiento1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 350, -1, -1));
        ...
        jbtnAgregarZapatillas.setBackground(new java.awt.Color(0, 0, 0));
        jbtnAgregarZapatillas.setFont(new java.awt.Font("Mongolian Baiti", 0, 12)); // NOI18N
        jbtnAgregarZapatillas.setForeground(new java.awt.Color(255, 255, 255));
        jbtnAgregarZapatillas.setText("Agregar al carrito");
        jbtnAgregarZapatillas.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jbtnAgregarZapatillasActionPerformed(evt);
            }
        });
        pEquipamiento1.add(jbtnAgregarZapatillas, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 190, 120, 20));
    ...
    private void jbtnAgregarZapatillasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnAgregarZapatillasActionPerformed
      
        
    }//GEN-LAST:event_jbtnAgregarZapatillasActionPerformed
    ...
    private javax.swing.JButton jbtnAgregarZapatillas;
